...
const fashionCards = [
  ...
  {
    name: 'Ночная сыворотка Advanced',
    link: 'https://images.unsplash.com/photo-1648291533610-e4a74f12ec02?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=435&q=80',
    date: '26.03.2022',
  },
  {
    name: 'Наьор для макияжа',
...
const interiorCards = [
  {
    name: 'Домашний декор, фойе',
    link: 'https://images.unsplash.com/photo-1684662863663-d25e39fc4c10?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80',
    date: '22.05.2023',
  },
  {
    name: 'Гостиная, лобби',
...
//const buyPopupButton = document.querySelector('.button-buy');
...
//const thinkPopup = new Popup('.popup_thank');
